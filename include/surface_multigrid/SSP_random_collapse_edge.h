#ifndef SSP_RANDOM_COLLAPSE_EDGE_H
#define SSP_RANDOM_COLLAPSE_EDGE_H
...
// {
  ...
  // [IGL_RANDOM_COLLAPSE_EDGE_NULL IGL_RANDOM_COLLAPSE_EDGE_NULL IGL_RANDOM_COLLAPSE_EDGE_NULL].
  ...
  #define IGL_RANDOM_COLLAPSE_EDGE_NULL 0
